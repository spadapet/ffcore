...
NS_IMPLEMENT_REFLECTION(CollectionSortBehavior, "NoesisGUIExtensions.CollectionSortBehavior")
{
    ...
    [](Noesis::DependencyObject* d, const Noesis::DependencyPropertyChangedEventArgs& e)
    {
        ...
        SortComparer* oldComparer = ((const Noesis::Ptr<SortComparer>*)e.oldValue)->GetPtr();
        behavior->UnregisterComparer(oldComparer);

        SortComparer* newComparer = ((const Noesis::Ptr<SortComparer>*)e.newValue)->GetPtr();
    ...
    [](Noesis::DependencyObject* d, const Noesis::DependencyPropertyChangedEventArgs& e)
    {
        ...
        Noesis::BaseComponent* oldSource = ((const Noesis::Ptr<Noesis::BaseComponent>*)e.oldValue)->GetPtr();
        behavior->UnregisterItemsSource(oldSource);

        Noesis::BaseComponent* newSource = ((const Noesis::Ptr<Noesis::BaseComponent>*)e.newValue)->GetPtr();
