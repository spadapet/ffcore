    ...
    const Noesis::DependencyPropertyChangedEventArgs& e)
{
    ...
    StyleBehaviorCollection* styleBehaviors = ((const Noesis::Ptr<StyleBehaviorCollection>*)
        e.newValue)->GetPtr();
    ...
    const Noesis::DependencyPropertyChangedEventArgs& e)
{
    ...
    StyleTriggerCollection* styleTriggers = ((const Noesis::Ptr<StyleTriggerCollection>*)
        e.newValue)->GetPtr();
