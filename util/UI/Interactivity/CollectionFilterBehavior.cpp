...
NS_IMPLEMENT_REFLECTION(CollectionFilterBehavior, "NoesisGUIExtensions.CollectionFilterBehavior")
{
    ...
    [](Noesis::DependencyObject* d, const Noesis::DependencyPropertyChangedEventArgs& e)
    {
        ...
        FilterPredicate* oldPredicate = ((const Noesis::Ptr<FilterPredicate>*)e.oldValue)->GetPtr();
        behavior->UnregisterPredicate(oldPredicate);

        FilterPredicate* newPredicate = ((const Noesis::Ptr<FilterPredicate>*)e.newValue)->GetPtr();
    ...
    [](Noesis::DependencyObject* d, const Noesis::DependencyPropertyChangedEventArgs& e)
    {
        ...
        if (predicate != nullptr)
        {
            Noesis::BaseComponent* source = ((const Noesis::Ptr<Noesis::BaseComponent>*)e.newValue)->GetPtr();
