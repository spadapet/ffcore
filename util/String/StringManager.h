...
namespace ff
{
	...
	public:
		...
		ff::StringBuffer* NewVector();
		ff::StringBuffer* NewVector(const ff::StringBuffer& rhs);
		void DeleteVector(ff::StringBuffer* str);
	...
	private:
		...
		PoolAllocator<ff::StringBuffer> _vectorPool;
	};
}
