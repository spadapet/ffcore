...
namespace ff
{
	...
	{
		UTIL_API static wchar_t* Malloc(size_t count);
		UTIL_API static void Free(wchar_t* str);
	};

	class StringBuffer : public ff::Vector<wchar_t, 16, StringAllocator>
	{
	public:
		UTIL_API StringBuffer();
	...
	public:
		...
		typedef StringBuffer::reverse_iterator reverse_iterator;
		typedef StringBuffer::const_reverse_iterator const_reverse_iterator;
	...
	private:
		StringBuffer& Str();
		const StringBuffer& StrConst() const;
