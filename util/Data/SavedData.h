...
namespace ff
{
	...
	UTIL_API bool CreateLoadedDataFromMemory(IData* pData, bool bCompress, ISavedData** ppSavedData);
	UTIL_API bool CreateSavedDataFromMemory(IData* pData, size_t nFullSize, bool bCompressed, ISavedData** ppSavedData);
	UTIL_API bool CreateSavedDataFromFile(IDataFile* pFile, size_t nStart, size_t nSavedSize, size_t nFullSize, bool bCompressed, ISavedData** ppSavedData);
	...
	public:
		...
		virtual bool Clone(ISavedData** ppSavedData) const = 0;
		virtual bool Copy(const ISavedData* pDataSource) = 0;
	};
}
