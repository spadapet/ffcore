...
namespace ff
{
	...
	UTIL_API bool PathsEqual(StringRef path1, StringRef path2);
	UTIL_API bool PathInPath(StringRef parent, StringRef child);
	...
	UTIL_API bool WriteFile(HANDLE hFile, const void* pMem, size_t nBytes);
	...
	UTIL_API bool ReadWholeFileMemMapped(StringRef path, IData** ppData);
