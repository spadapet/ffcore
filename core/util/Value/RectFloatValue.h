...
namespace ff
{
	class RectFloatValue : public ff::Value
	{
	public:
		UTIL_API RectFloatValue(const ff::RectFloat& value);

		UTIL_API const ff::RectFloat& GetValue() const;
		UTIL_API static ff::Value* GetStaticValue(const ff::RectFloat& value);
	...
	class RectFloatValueType : public ff::ValueTypeBase<RectFloatValue>
	{
	public:
