...
namespace ff
{
	class DoubleVectorValue : public ff::Value
	{
	public:
		UTIL_API DoubleVectorValue(ff::Vector<double>&& value);

		UTIL_API const ff::Vector<double>& GetValue() const;
		UTIL_API static ff::Value* GetStaticValue(ff::Vector<double>&& value);
		UTIL_API static ff::Value* GetStaticDefaultValue();

	private:
		ff::Vector<double> _value;
	};

	class DoubleVectorValueType : public ff::ValueTypeBase<DoubleVectorValue>
	{
	public:
