...
namespace ff
{
	...
	UTIL_API Vector<char> StringToUTF8(StringRef text);
	UTIL_API Vector<uint32_t> StringToUCS4(StringRef text);
	UTIL_API size_t StringToUCS4(StringRef text, uint32_t* data, size_t dataSize);
